...
export default function Home() {
  ...
  <div>
   <footer className="bg-blue-950 h-10  text-white  text-sm text-center content-center font-semibold">Copyright 2024 - 2025<em> <Link href="https://www.linkedin.com/in/muhammadmazher/" className="border-b-2 h hover:text-blue-700 hover:border-blue-700">Emas Web Solution </Link></em>
   </footer>
  </div>
